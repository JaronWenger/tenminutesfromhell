            ...
            {(() => {
              ...
              return <>
                <p className="share-prompt-text">
                  ...
                  {isSafari && <>Tap <strong>···</strong> at the bottom of Safari, then tap <strong>Share</strong> <svg style={{ verticalAlign: 'middle' }} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" y1="2" x2="12" y2="15"/></svg>, then scroll and tap <strong>"Add to Home Screen"</strong>.</>}
